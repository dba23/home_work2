...
class VectorTest {
    ...
    public void testAdd() {
        // TC01: Simple test
        assertEquals("Wrong vector add", new Vector(1, 1, 1), (Supplier<String>) new Vector(2, 3, 4).add(new Vector(-1, -2, -3)));
    ...
    public void testSubtract() {
        ...
        assertEquals("Wrong vector subtract", new Vector(1, 1, 1),
                (Supplier<String>) new Vector(2, 3, 4).subtract(new Vector(1, 2, 3)));
    ...
    public void testScale() {
        ...
        assertEquals("Wrong vector scale", new Vector(2, 4, 6),
                (Supplier<String>) new Vector(1, 2, 3).scale(2));
...
//    }
    ...
    public void testCrossProduct() {
        ...
        Vector v3 = new Vector(new Point3D(new Coordinate(-2), new Coordinate(-4), new Coordinate(-6)));
        try {
            v1.crossProduct(v3);
    ...
    public void testPointSubtract() {
        // ============ Equivalence Partitions Tests ==============
        // TC01: Simple test
        assertEquals("Wrong point subtract", new Vector(new Point3D(new Coordinate(1), new Coordinate(2), new Coordinate(3))),
                (Supplier<String>) new Point3D(new Coordinate(2), new Coordinate(3), new Coordinate(4)).subtract(new Point3D(new Coordinate(1), new Coordinate(2), new Coordinate(3))));

        // =============== Boundary Values Tests ==================
        // TC11: test subtracting same point
        try {
            new Point3D(new Coordinate(1), new Coordinate(2), new Coordinate(3)).subtract(new Point3D(new Coordinate(1), new Coordinate(2), new Coordinate(3)));
